...
def main(shotname, elementname):
    ...
    print sg_colors.blue2 + "--- Begining of mvr_back_to_beauty.py --- " + sg_colors.endc
    # print ''

    import flame

    yaml_Pathnames_Path = "{root}/lib/project_config/ProjectPaths_config_result.yaml".format(root=root_path)
    ...
    print "shot number and name from From mvr_back_to_beauty.py: -> " + sg_colors.yellow1 + shotNumber + passElement + sg_colors.endc
    ...
    print sg_colors.grey3 + "current Flame Project: " + sg_colors.yellow1 + flame.project.current_project.project_name + sg_colors.endc
    print sg_colors.grey3 + "current Network Project: " + sg_colors.yellow1 + project_name + sg_colors.endc
    ...
    def get_shot_folders(project_name):
        ...
        # ########## The 3 following solutions work, although the hard coded one is just for testings.
        project_root = projects_root_path + '/' + projectName + "/shots"
        # project_root = "{jobroot}/{project_name}/shots".format(jobroot=projects_root_path, project_name=project_name)
        # project_root = "/Users/stefan/XenDrive/__WORK/PROJECTS/PULSE/17P520_python_API/shots"

        print sg_colors.grey3
    ...
    def get_flame_clip_paths(path, ext=None):
        ...
        return clip_paths
        print sg_colors.grey3 + "clip_paths" + clip_paths + sg_colors.endc

    # get_flame_clip_paths('/var/tmp/flame/house_projects/17P998flame_hooks_sg_console/shots/STF/STF_0010/img/output/3D/lighting')
        ...
        for path in get_flame_clip_paths(root, ext='exr'):
            ...
            if shotNumber in path:
                if passElement in path:
                    ...
                    print sg_colors.grey3 + path + sg_colors.endc
    ...
    mux_AO = flame.batch.create_node("Mux")
    mux_AO.name = "mux_AO"
    mux_AO.pos_x = 2750
    mux_AO.pos_y = 1600

    mux_Zdepth = flame.batch.create_node("Mux")
    mux_Zdepth.name = "mux_Zdepth"
    mux_Zdepth.pos_x = 3600
    mux_Zdepth.pos_y = 1000
    ...
    comp_refraction.name = "comp_refraction"
    ...
    comp_specular.name = "comp_specular"
    ...
    # media
    writeFile01.media_path = "/disks/nas0/CGI/R_n_D/work.stefan/src/flame/house_projects/17P998_python_console/shots/STF/"
    ...
    print ''
    print sg_colors.grey3 + "shotNumber: " + sg_colors.yellow1 + shotNumber + sg_colors.endc
    print sg_colors.grey3 + "passElement: " + sg_colors.yellow1 + passElement + sg_colors.endc
    print ''
    ...
    flame.batch.connect_nodes(AO_pass, shotNumber + passElement + ".AO.0001_ABGR", mux_AO, "Input_0")
    flame.batch.connect_nodes(Zdepth_pass, shotNumber + passElement + ".Zdepth.0001_ABGR", mux_Zdepth, "Input_0")
    ...
    flame.batch.connect_nodes(mux_AO, "Result", cc_AO, "Front")
    flame.batch.connect_nodes(mux_Zdepth, "Result", cc_Zdepth, "Front")
    ...
    # print "\x1b[38;5;202m --- End of mvr_back_to_beauty.py --- \x1b[0m"
    print sg_colors.orange1 + " --- End of mvr_back_to_beauty.py ---" + sg_colors.endc
