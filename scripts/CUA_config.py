...
from lib.project_config import infoStaff_layout
from lib.project_config import ExportPresets_layout
...
yaml_Staff = "{root}/lib/project_config/InfoStaff_config_result.yaml".format(root=root_path)
yaml_export_presets = "{root}/lib/project_config/ExportPresets_result.yaml".format(root=root_path)
    ...
    if info['name'] == 'exports_config':
        ...
        class PathsTab(QMainWindow, ProjectPaths_layout.Ui_ProjectPathsLayout):
            ...
            def browse_project(self):
                # print "\x1b[38;5;75m ---  def browse_project(self): in class PathsTab(QMainWindow, ProjectPaths_layout.Ui_ProjectPathsLayout): inside CustomUIaction_Uililities.py --- \x1b[0m"
                print sg_colors.green1 + "--- def browse_path(self): in class PathsTab(QMainWindow, ProjectPaths_layout.Ui_ProjectPathsLayout): inside CustomUIaction_Uililities.py ---" + sg_colors.endc
            ...
            def saveYaml(self):
                # print "\x1b[38;5;75m ---  def saveYaml(self): in class PathsTab(QMainWindow, ProjectPaths_layout.Ui_ProjectPathsLayout): inside CustomUIaction_Uililities.py --- \x1b[0m"
                print sg_colors.green1 + "--- def browse_path(self): in class PathsTab(QMainWindow, ProjectPaths_layout.Ui_ProjectPathsLayout): inside CustomUIaction_Uililities.py ---" + sg_colors.endc
                data = {
                ...
                # with open('/opt/flame_dev/flame_hooks_sg/hooks_py_apps/utilities/ProjectPaths_config_result.yaml', 'w') as export_hook_config:
